    ...
    <section className="flex min-h-screen items-center justify-center px-6">
      <div className="max-w-3xl">
        ...
        <div className="animate-fade-in-up mt-8 flex flex-wrap gap-4 opacity-0 animate-delay-400">
          ...
          <a
            href="#contact"
            className="rounded-md border border-card-border px-6 py-3 font-mono text-sm font-medium text-foreground transition-colors hover:border-accent hover:text-accent"
          >
            Get in touch
          </a>
        </div>
